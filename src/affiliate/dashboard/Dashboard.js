...
import { getDashboardData } from '../reducer/affiliateDashboardReducer';
import { toDateString } from '../../functions/dateformate';

const Dashboard2 = () => {
	const dispatch = useDispatch();

	const { dashboard: { coupons, couponCount, enrollmentCount, enrollments, totalSellAmount, totalEarnings } } = useSelector(state => state.affiliateDashboard);
		...
		<AffiliateBase>
			<div className='dashboardContainer'>
				<div className="headingBar">
					<h2 className='PageHeading'>Affiliate Dashboard</h2>
